...
<div class="android-more-section">
  ...
  <div class="android-card-container mdl-grid">
	...
	<span  id="pageno" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-color--accent mdl-color-text--accent-contrast">
	 <?php if($this->session->userdata('user_id') && $this->session->userdata('user_type') != 'user')
     { ?>
	 <a style="color: green" href="<?=  site_url('/')?>blog/new_post/"><span class="glyphicon glyphicon-pencil"></span> Create a new post</a>
	 <?php 
	 } ?>
